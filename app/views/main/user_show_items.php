...
$sql = "SELECT DISTINCT\n"
    ...
    . "FROM\n"
    . "Oferta\n"
    . "INNER JOIN posrednia ON posrednia.id_oferta = oferta.id_oferta\n"
    ...
    . "INNER JOIN transakcja on transakcja.id_transakcja = posrednia.id_transakcja\n"
    . "WHERE transakcja.id_kupujacego =\n"
